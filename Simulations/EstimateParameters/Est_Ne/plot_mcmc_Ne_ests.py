...
path = './'
true_vals = np.loadtxt(path+'test_SCAR_linearScale_true_Ne.csv',delimiter=",")
est_vals = np.loadtxt(path+'test_SCAR_linearScale_mcmc_Ne_ests.csv',delimiter=",")
...
fig.tight_layout()
plt.show()
fig.savefig('test_SCAR lineageScale_mcmc_true_vs_estNe.png', dpi=200)
