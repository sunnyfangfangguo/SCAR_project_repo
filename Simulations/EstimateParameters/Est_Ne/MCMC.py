...
def sample(params,est_params,ts_sim_file,iterations=1000,opt_iters=[],burnin=0,plot=False,**plot_info):
    ...
    p_now = SCARLikelihood.compute_like(ts_sim_file,**params) * prior # current posterior prob
    ...
    for i in range(1,iterations): # was range(2,iterations)
        ...
        p_new = SCARLikelihood.compute_like(ts_sim_file,**params) * prior # posterior prob for proposed theta
