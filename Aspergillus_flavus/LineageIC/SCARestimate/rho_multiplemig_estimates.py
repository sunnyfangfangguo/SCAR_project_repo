...
"Specify params"
samples = 17,13,13,5
genome_length = 5123149
rho = 1.11e-3 #region recombination rate per generation
Ne = 9674  # effective pop sizes
...
opt_iters = []
opt_iters = [200,500,1000,3000,5000,7000,9000,10000,12000,14000,16000,18000,20000,25000,30000,35000,38000]
