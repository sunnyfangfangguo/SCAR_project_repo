...
"paramterss"
rho_per_site = 1.37e-09  # recombination rate per site per generation
mutation_rate = 2.82e-09    # mutation rate per site per generation
Ne = 1554  # effective population size
maxtime = 3100     # maxtime of ARG, can set as TMRCA time
...
aflavus_fasta = path + "51IB_4pops_m06SNP_sites.sites"
...
run_argweaver(seq_file=aflavus_fasta, Ne=Ne, recombination_rate=rho_per_site, 
               mutation_rate=mutation_rate, path_prefix=smc_files_prefix, seed=2132, MSMC_samples=MSMC_samples, 
